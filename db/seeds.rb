...
User.create(email: "user1@test.com", password: "password1", password_confirmation: "password1", role_id: 1 )
User.create(email: "employee@test.com", password: "password2", password_confirmation: "password2", role_id: 2 )
