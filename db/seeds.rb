...
User.create(email: "user1@test.com", password: "password1", password_confirmation: "password1", role: role_1 )
User.create(email: "employee@test.com", password: "password2", password_confirmation: "password2", role: role_2 )
