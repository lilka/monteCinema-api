...
module Reservations
  module UseCases
    class Create
      ...
      def initialize(params:, repository: ReservationRepository.new)
      ...
      def call
        raise SeatsNotValidError, "Seats with given ids are not valid or there is not enough free seats" if  ReservationSeats::Validator.new(seat_ids, params[:screening_id]).valid? == true
